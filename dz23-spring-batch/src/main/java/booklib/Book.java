...
public class Book {
	...
	// данный геттер требуется для загрузки данных MongoDB-> Oracle, потому что в Oracle имена колонок не могут начинаться с подчеркивания
	public String getId() { return id; }

	// Если бы в Oracle колонка ID имела тип NUMBER, то такое тоже срабатывало:
	//public Long getId() { return Math.round(Math.random() * 100000000) ;}
